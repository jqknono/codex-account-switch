...
| --- | --- | --- |
| `codex-account-switch.quotaRefreshInterval` | `5` | Automatic background quota refresh interval, in seconds; minimum `5`; each interval refreshes one saved account quota in rotation |
